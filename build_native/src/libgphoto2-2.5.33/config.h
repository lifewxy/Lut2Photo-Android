...
#define GP_CAMLIB_SET "ax203 canon digigr8 dimagev directory jl2005a jl2005c kodak_dc240 mars pentax ptp2 quicktake1x0 ricoh_g3 sierra sonix sq905 st2205 topfield tp6801"

/* define when the camlib set to build is non-standard */
/* #undef GP_CAMLIB_SET_IS_NONSTANDARD */

/* If defined, the camlibs which are skipped due to missing dependencies */
#define GP_CAMLIB_SET_SKIPPING "docupen lumix"

/* Define if there is asm .symver support. */
#define HAVE_ASM_SYMVERS 1

/* The C compiler we are using */
#define HAVE_CC "/mnt/d/AndroidStudioSDK/ndk/android-ndk-r29-linux/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi31-clang"
...
#define PACKAGE_STRING "libgphoto2 photo camera library 2.5.33"
...
#define URL_DIGICAM_LIST "http://gphoto.org/proj/libgphoto2/support.php"
